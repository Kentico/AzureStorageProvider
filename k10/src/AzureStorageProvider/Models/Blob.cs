...
namespace AzureStorageProvider.Models
{
    public class Blob : IObjectWithPath<Blob>
    {
        ...
        private ICloudBlobService _cloudBlobService = Service<ICloudBlobService>.Entry();
        private IBlobCacheService _blobCacheService = Service<IBlobCacheService>.Entry();
