...
namespace AzureStorageProvider.Tests
{
    ...
    public class BlobDirectoryTests
    {
        ...
        private FakeServices.CloudDirectoryService _cloudDirectoryService = Service.Resolve<AzureStorageProvider.Azure.ICloudDirectoryService>() as FakeServices.CloudDirectoryService;
        private FakeServices.CloudBlobService _cloudBlobService = Service.Resolve<AzureStorageProvider.Azure.ICloudBlobService>() as FakeServices.CloudBlobService;
        [SetUp]
        public void SetUp()
        {
