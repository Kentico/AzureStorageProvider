...
namespace AzureStorageProvider.Tests
{
    ...
    public class CacheClearingTaskTests
    {
        ...
        private FakeServices.CloudBlobService _cloudBlobService = Service.Resolve<ICloudBlobService>() as FakeServices.CloudBlobService;
        private FakeServices.BlobCacheService _blobCacheService = Service.Resolve<IBlobCacheService>() as FakeServices.BlobCacheService;
        private FakeServices.CloudDirectoryService _cloudDirectoryService = Service.Resolve<ICloudDirectoryService>() as FakeServices.CloudDirectoryService;
        [SetUp]
        public void SetUp()
        {
